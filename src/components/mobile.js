...
import { getMobiles, setSelectedItem } from "../redux/productslice";
...
function Mobiles() {
  ...
  return (<div>
    ...
    <h1 className="fashion-h1">MOBILE COLLECTIONS</h1>

    <div className="womens-container">
    {women.getMobiles?.map((pro,index) =>{
      return (
