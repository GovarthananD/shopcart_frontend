...
import { getElectronics, setSelectedItem } from "../redux/productslice";
...
function Electronics() {
  ...
  return (<div>
    ...
    <h1 className="fashion-h1">ELECTRONICS</h1>

    <div className="womens-container">
    {women.getElectronics?.map((pro,index) =>{
      return (
