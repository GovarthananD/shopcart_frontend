...
const {women, status, error} = useSelector((state) => state.products);
...
if (status === 'loading') return <p>Loading...</p>;
  ...
  return (<div>
    ...
    <h1 className="fashion-h1">WOMENS COLLECTIONS</h1>


  <div className="womens-container">
    {women.getFashion?.map((pro,index) =>{
      return (
