...
import { getGrooming, setSelectedItem } from "../redux/productslice";
...
function Grooming () {
 ...
 <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark" border-body fixed-top>
    ...
    <h1 className="fashion-h1">GROOMINGS</h1>

    <div className="womens-container">
    {women.getGrooming?.map((pro,index) =>{
      return (
